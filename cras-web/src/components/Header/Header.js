...
const products = [
  { name: 'Vídeos', description: 'Gerenciar os vídeos da aplicação', href: '/videos', icon: CursorArrowRaysIcon },
  { name: 'Jogos', description: 'Gerenciar os jogos da aplicação', href: '/jogos', icon: FingerPrintIcon },
  { name: 'Turmas', description: 'Gerenciar as turmas da aplicação', href: '/turmas', icon: ChartPieIcon },
  { name: 'Professores (temporario)', description: 'Gerenciar os professores da aplicação', href: '/professores', icon: SquaresPlusIcon },
]

const roomTypes = [
  { name: 'Vídeos (em breve)', description: 'Criar uma sala de vídeos', href: null, icon: CursorArrowRaysIcon },
  { name: 'Jogos', description: 'Criar uma sala de jogos', href: '/jogar', icon: FingerPrintIcon },
]
