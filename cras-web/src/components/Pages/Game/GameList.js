...
function GameList() {
    ...
    <div className="container px-6 pb-10 mx-auto">
        <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl text-center">Jogos disponíveis</h1>
        <div className="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
            <Link to='/jogo-teste' className="lg:flex shadow p-3 cursor-pointer hover:scale-105 transition-all">
                ...
                <div className="flex flex-col justify-between py-6 lg:mx-6">
                    ...
                    <span className="text-sm text-gray-500 ">Cooperação</span>
                </div>
            </Link>
            ...
            <div className="lg:flex shadow p-3 cursor-pointer hover:scale-105 transition-all">
                ...
                <div className="flex flex-col justify-between py-6 lg:mx-6">
                    ...
                    <span className="text-sm text-gray-500 ">Reciclagem</span>
                </div>
            </div>
            ...
            <div className="lg:flex shadow p-3 cursor-pointer hover:scale-105 transition-all">
                ...
                <div className="flex flex-col justify-between py-6 lg:mx-6">
                    ...
                    <span className="text-sm text-gray-500 ">Trânsito</span>
                </div>
            </div>
        </div>
    </div>
